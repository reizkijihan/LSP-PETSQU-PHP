...
<body>
  <div id="wrapper">
    ...
    <a class="navbar-brand" href="index.php?page=home">PetsQu</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="index.php?page=katalog">Katalog<span class="sr-only">(current)</span></a>
          </li>
           <li class="nav-item active">
            <a class="nav-link" href="index.php?page=login">Registrasi/Login<span class="sr-only">(current)</span></a>
          </li>
              </ul>
            </li>
          </ul>
